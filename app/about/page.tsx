...
export default function AboutPage() {
    ...
    return (
        ...
        <div className="bg-white text-slate-800">
            ...
            {/* Switched to slate-900 for a more premium dark look */}
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto text-center mb-16">
                        <h2
                            ...
                            data-aos="fade-up"
                        >
                            Key Facts of AZ Refrigeration
                        </h2>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                        {/* Cards are dynamically generated by the helper component */}
                        <KeyFactCard
                            icon={Settings}
            ...
            {/* --- 5. Our Core Team Section --- */}
            {/* Light slate background to make the white cards pop */}
            <section className="bg-slate-50 py-20 lg:py-28">
                <div className="container mx-auto px-6">
                    ...
                    {/* Constrained width for a 2-person team to look better */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        <TeamMemberCard
                            name="Mr. Afroz Siddiqui"
                            role="Founder"
                            // High-quality placeholder portrait
